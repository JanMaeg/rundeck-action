...
const send_api_request_1 = __importDefault(__nccwpck_require__(2498));
function executeJob({ jobId }) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield (0, send_api_request_1.default)({
            url: `job/${jobId}/run`
        });
        ...
        core.info(`Job "${data.job.name}" has been successfully triggered. ${data.permalink}`);
        return {
...
exports["default"] = getExecutionStatus;
...
function sendAPIRequest({ urlParameter = new URLSearchParams(), url = '', method = 'POST' }) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports["default"] = sendAPIRequest;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const get_execution_status_1 = __importDefault(__nccwpck_require__(1180));
const timeout_promise_1 = __importDefault(__nccwpck_require__(5131));
/**
 ...
 */
function checkStatus({ executionId, averageDuration = 5000 }) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const MAX_CHECK_COUNT = (_a = process.env.MAX_CHECK_AMOUNT) !== null && _a !== void 0 ? _a : 10;
        let checkCount = 0;
        let status = 'running';
        let timeoutDuration = averageDuration;
        core.info(`Checking status after average execution time of ${averageDuration}ms.`);
        while (status === 'running' && checkCount < MAX_CHECK_COUNT) {
            checkCount++;
            core.info(`Waiting ${timeoutDuration}ms before checking again for execution status.`);
            yield (0, timeout_promise_1.default)(() => __awaiter(this, void 0, void 0, function* () {
                core.info('Checking execution status of job.');
                const response = yield (0, get_execution_status_1.default)({ executionId });
                status = response.status;
                core.info(`Execution status is ${status}`);
            }), timeoutDuration);
            if (checkCount === 1) {
                timeoutDuration = (_b = process.env.TIMEOUT_BETWEEN_STATUS_CHECK) !== null && _b !== void 0 ? _b : 1000;
            }
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const check_status_1 = __importDefault(__nccwpck_require__(4976));
const execute_job_1 = __importDefault(__nccwpck_require__(6653));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const jobId = core.getInput('job_id');
            const waitUntilFinished = core.getInput('wait_until_finished') === 'true';
            const response = yield (0, execute_job_1.default)({ jobId });
            if (waitUntilFinished) {
                yield (0, check_status_1.default)({
 ...
 * @param time
 */
function timeoutPromise(method, time) {
    return __awaiter(this, void 0, void 0, function* () {
